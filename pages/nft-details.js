...
const PaymentBodyCmp = ({ nft, nftCurrecy }) => (
  <div className="flex flex-col">
    ...
    <div className="flexBetweenStart my-5">
      ...
      <div>
        <p className="font-poppins dark:text-white text-nft-black-1 text-sm minlg:text-xl font-normal">
          {nft.price} <span className="font-semibold">{nftCurrecy}</span>
        </p>
      </div>
    </div>
...
const NFTDetails = () => {
  const { currentAccount, nftCurrecy, buyNft } = useContext(NFTContext);
  ...
  return (
    <div className="relative flex justify-center md:flex-col min-h-screen">
      ...
      <div className="flex-1 justify-start sm:px-4 p-12 sm:pb-4">
        ...
        <div className="flex flex-row sm:flex-col mt-10">
          {currentAccount === nft.seller.toLowerCase() ? (
            ...
            <Button
              btnName={`Buy for ${nft.price} ${nftCurrecy}`}
              btnType="primary"
              classStyles="mr-5 sm:mr-0 sm:mb-5 rounded-xl"
      ...
      {paymentModal && (
        <Modal
          header="Check Out"
          body={<PaymentBodyCmp nft={nft} nftCurrecy={nftCurrecy} />}
          footer={
          ...
          footer={
            ...
            <div className="flexCenter flex-col">
              <Button
                ...
                handleClick={() => router.push('/my-nft')}
              />
            </div>
          }
